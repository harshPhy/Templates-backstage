...
allocated_storage       = "${{ values.allocated_storage | default(20) }}"
...
// Availability & backup
multi_az                = "${{ values.multi_az | default(false) }}"
publicly_accessible     = "${{ values.publicly_accessible | default(false) }}"
backup_retention_period = "${{ values.backup_retention_period | default(7) }}"
